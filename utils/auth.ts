...
export const auth = {
    ...
    async logout(): Promise<void> {
        try {
            ...
            console.warn('⚠️ [AUTH] Logout API Failed');
        }
    ...
    async isAuthenticated(): Promise<boolean> {
        ...
        // FIXED: Changed the logic - if token IS expired, try to refresh
    ...
    async fetch(url: string, options: RequestInit = {}): Promise<Response> {
        ...
        // Use global fetch (not this.fetch to avoid infinite recursion)
